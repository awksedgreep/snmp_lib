...
IO.puts("🔍 ANALYZING WORKING DIRECTORY FAILURES")
IO.puts("======================================")

working_dir = "/Users/mcotner/Documents/elixir/snmp_lib/test/fixtures/mibs/working"
{:ok, files} = File.ls(working_dir)
...
IO.puts("Testing #{length(mib_files)} files in working directory...")
