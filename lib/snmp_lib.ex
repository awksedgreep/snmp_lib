defmodule SnmpLib do
  ...
  - **`SnmpLib.PDU`** - SNMP PDU encoding/decoding with full RFC compliance
  ...
  ### Low-Level PDU Operations
      ...
      iex> bulk_pdu = SnmpLib.PDU.build_get_bulk_request([1, 3, 6, 1, 2, 1, 2, 2], 456, 0, 10)
      iex> bulk_pdu.type
      :get_bulk_request
  ...
  def info do
    %{
      ...
      modules: %{
        ...
        "SnmpLib.Dashboard" => "Real-time monitoring and visualization",
        "SnmpLib.Cache" => "Intelligent caching system",
        "SnmpLib.PDU" => "SNMP PDU encoding/decoding",
