defmodule SnmpLib.MIB do
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.compile("priv/mibs/RFC1213-MIB.txt")
      {:error, [%SnmpLib.MIB.Error{type: :file_not_found, ...}]}
  """
  @spec compile(Path.t() | binary(), compile_opts()) :: {:error, [SnmpLib.MIB.Error.t()]}
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.compile_string(mib_content)
      {:ok, %{name: "RFC1213-MIB", ...}}
  """
  @spec compile_string(binary(), compile_opts()) :: {:error, [SnmpLib.MIB.Error.t()]}
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.load_compiled("lib/generated/rfc1213_mib.ex")
      {:ok, %{name: "RFC1213-MIB", ...}}
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.compile_all(mibs)
