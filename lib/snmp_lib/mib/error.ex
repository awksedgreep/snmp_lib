defmodule SnmpLib.MIB.Error do
  ...
  @type error_type ::
    ...
    :file_not_found | :unterminated_string | :unexpected_token |
    :unexpected_eof | :invalid_number | :invalid_identifier
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.Error.new(:unexpected_token, 
      ...>   expected: :max_access,
      ...>   actual: :access,
      ...>   line: 42,
      ...>   column: 10
  ...
  ## Examples
      ...
      iex> error = SnmpLib.MIB.Error.new(:syntax_error, line: 42, column: 10)
      iex> SnmpLib.MIB.Error.format(error)
  ...
  defp generate_suggestions(:file_not_found, opts) do
    ...
    if String.contains?(file, "RFC") or String.contains?(file, "MIB") do
      suggestions ++ ["Check MIB file naming conventions", "Verify file extension (.txt, .mib, .my)"]
    else
      suggestions
    end
  end
