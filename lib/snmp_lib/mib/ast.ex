defmodule SnmpLib.MIB.AST do
  ...
  @type definition :: 
    object_type() | object_identity() | object_group() | 
    notification_type() | notification_group() | module_identity() |
    module_compliance() | agent_capabilities() | textual_convention() |
    trap_type() | object_identifier_assignment()
  ...
  @type primitive_syntax ::
    :integer | :octet_string | :object_identifier | :null | :real |
    {:integer, constraints()} | {:octet_string, constraints()} |
  ...
  # Access Levels
  @type access_level :: 
    :not_accessible | :accessible_for_notify | :read_only | 
    :read_write | :read_create |
  ...
  # Default Values
  @type default_value ::
    nil | integer() | binary() | atom() | [default_value()] |
    {:named_value, binary()} | {:bit_string, [binary()]}
  ...
  def determine_snmp_version(definitions) do
    has_module_identity = Enum.any?(definitions, fn
  ...
  def validate_node(%{__type__: type} = node) when type in [
    :mib, :object_type, :object_identity, :module_identity, :object_group,
    :notification_type, :notification_group, :module_compliance,
    :agent_capabilities, :textual_convention, :trap_type,
    :object_identifier_assignment, :import, :revision
  ] do
    {:ok, node}
  end
