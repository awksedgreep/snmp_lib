defmodule SnmpLib.MIB.Registry do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.Registry.resolve_name("sysDescr.0")
      {:ok, [1, 3, 6, 1, 2, 1, 1, 1, 0]}

      iex> SnmpLib.MIB.Registry.resolve_name("sysDescr")
      {:ok, [1, 3, 6, 1, 2, 1, 1, 1]}

      iex> SnmpLib.MIB.Registry.resolve_name("unknownName")
      {:error, :not_found}
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.Registry.reverse_lookup([1, 3, 6, 1, 2, 1, 1, 1, 0])
      {:ok, "sysDescr.0"}

      iex> SnmpLib.MIB.Registry.reverse_lookup([1, 3, 6, 1, 2, 1, 1, 1])
      {:ok, "sysDescr"}
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.Registry.children([1, 3, 6, 1, 2, 1, 1])
  ...
  ## Examples
      ...
      iex> SnmpLib.MIB.Registry.walk_tree([1, 3, 6, 1, 2, 1, 1])
