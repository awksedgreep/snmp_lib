defmodule SnmpLib.PDU do
  ...
  **IMPORTANT**: Always use the `:type` field (not `:pdu_type`) with atom values.
  ...
  {:ok, pdu} = SnmpLib.PDU.build_get_request([1, 3, 6, 1, 2, 1, 1, 1, 0], 123)
  
  # GETBULK request for interface table
  {:ok, pdu} = SnmpLib.PDU.build_get_bulk_request([1, 3, 6, 1, 2, 1, 2, 2, 1], 124, 0, 10)
  
  # SET request
  {:ok, pdu} = SnmpLib.PDU.build_set_request([1, 3, 6, 1, 2, 1, 1, 5, 0], {:octet_string, "New Name"}, 125)
  ```
  ...
  # Decode from binary
  {:ok, decoded_message} = SnmpLib.PDU.decode_message(packet)
  ```
  ...
  error_pdu = SnmpLib.PDU.create_error_response(original_pdu, :no_such_name, 1)
  ```
  """

  alias SnmpLib.PDU.{Constants, Builder, Encoder, Decoder}
  ...
  ## Examples
      ...
      iex> {:ok, _binary} = SnmpLib.PDU.encode_message(message)
  """
  ...
  ## Examples
      ...
      iex> {:ok, binary} = SnmpLib.PDU.encode_message(%{version: 1, community: "public", pdu: %{type: :get_request, request_id: 123, error_status: 0, error_index: 0, varbinds: []}})
      iex> {:ok, _message} = SnmpLib.PDU.decode_message(binary)
  """
  ...
  ## Examples
      ...
      :get_request
  """
  @spec build_get_request(oid() | [oid()], non_neg_integer()) :: {:ok, pdu()} | {:error, atom()}
  ...
  ## Examples
      ...
      iex> {:ok, pdu} = SnmpLib.PDU.build_get_next_request([1, 3, 6, 1, 2, 1, 1], 124)
      iex> pdu.type
      :get_next_request
  """
  @spec build_get_next_request(oid() | [oid()], non_neg_integer()) :: {:ok, pdu()} | {:error, atom()}
  def build_get_next_request(oid_or_oids, request_id), do: Builder.build_get_next_request(oid_or_oids, request_id)
  ...
  ## Examples
      ...
      iex> {:ok, pdu} = SnmpLib.PDU.build_get_bulk_request([1, 3, 6, 1, 2, 1, 2, 2, 1], 125, 0, 10)
      iex> pdu.type
      :get_bulk_request
  """
  @spec build_get_bulk_request(oid() | [oid()], non_neg_integer(), non_neg_integer(), non_neg_integer()) :: {:ok, pdu()} | {:error, atom()}
  ...
  ## Examples
      ...
      iex> {:ok, pdu} = SnmpLib.PDU.build_set_request([1, 3, 6, 1, 2, 1, 1, 5, 0], {:octet_string, "New Name"}, 126)
      iex> pdu.type
      :set_request
  """
  @spec build_set_request(oid(), {atom(), any()}, non_neg_integer()) :: pdu()
  def build_set_request(oid_list, type_value, request_id), do: Builder.build_set_request(oid_list, type_value, request_id)
  ...
  ## Examples
      ...
      :get_response
  """
  @spec build_response(pdu(), [varbind()], error_status(), non_neg_integer()) :: {:ok, pdu()} | {:error, atom()}
  def build_response(request_pdu, varbinds, error_status \\ 0, error_index \\ 0) do
    Builder.build_response(request_pdu, varbinds, error_status, error_index)
  end
  ...
  ## Examples
      ...
      iex> request_pdu = %{type: :get_request, request_id: 123, error_status: 0, error_index: 0, varbinds: []}
      iex> error_pdu = SnmpLib.PDU.create_error_response(request_pdu, :no_such_name, 1)
  ...
  ## Examples
      ...
      iex> {:ok, ^pdu} = SnmpLib.PDU.validate(pdu)
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.PDU.normalize_oid([1, 3, 6, 1, 2, 1, 1, 1, 0])
      [1, 3, 6, 1, 2, 1, 1, 1, 0]
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.PDU.normalize_type(:string)
      :octet_string
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.PDU.error_status_to_code(:no_such_name)
      2
  """
  ...
  ## Examples
      ...
      iex> SnmpLib.PDU.error_status_to_atom(2)
      :no_such_name
  """
