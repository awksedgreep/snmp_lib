defmodule SnmpLib.DocsisMibTest do
  ...
  describe "Critical DOCSIS MIBs" do
    ...
    test "DOCS-CABLE-DEVICE-MIB contains expected DOCSIS constructs" do
      ...
      assert has_definition_type(mib, :textual_convention), "Should have TEXTUAL-CONVENTION definitions"
    ...
    test "DOCS-QOS-MIB contains expected QoS constructs" do
      ...
      assert has_definition_type(mib, :module_compliance), "Should have MODULE-COMPLIANCE definitions"
    end
  end
  ...
  defp test_mib_group(mibs, group_name) do
